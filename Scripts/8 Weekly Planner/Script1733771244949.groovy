...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/acuity_dashboard/today')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Weekly Planner Dashboard/div_Select Group'))

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Weekly Planner Dashboard/div_All groups'))

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Weekly Planner Dashboard/button_Apply filters'))
