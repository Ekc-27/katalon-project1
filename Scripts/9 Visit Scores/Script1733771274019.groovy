...
WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Today/div_Select Group'))

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Today/div_All groups'))

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Today/button_Apply filters'))
