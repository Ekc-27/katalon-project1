...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/reports/default_user')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Caseload/input_Show Archived Patients_commit'))
