...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/reports/dna_report/index')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Dna Report/input_Show Archived Patients_commit'))
