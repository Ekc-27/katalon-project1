...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/repeating_events/groups')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Day/input__commit'))
