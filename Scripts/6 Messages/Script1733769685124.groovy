...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/current_user_messages')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Current User_0dce72/input_Filter by Group_commit'))

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Current User_0dce72/a_Unresolved Messages Created By You'))

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Current User_0dce72/a_Account Messages'))
