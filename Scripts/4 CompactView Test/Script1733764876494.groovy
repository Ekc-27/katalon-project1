...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/users/compact_week_index')

Thread.sleep(3000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Compact Week/input_Visits must include all selected inte_32b629'))
