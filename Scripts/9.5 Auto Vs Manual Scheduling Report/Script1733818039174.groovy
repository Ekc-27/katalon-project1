...
WebUI.navigateToUrl('https://next.malinko-uat.co.uk/reports/auto_vs_manual_scheduling/index')

Thread.sleep(2000)

WebUI.click(findTestObject('Object Repository/Page_Civica Scheduling - Index Auto Vs Manu_ef6f5c/input_End Date_commit'))
